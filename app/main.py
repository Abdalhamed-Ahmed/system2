...
def updatePaper(paper_id):
    ...
    return render_template(
        "update.html", paper=selectedPaper, categories=categories, fileNames=fileNames
    )
...
def home():
    ...
    if (
        params_fileName
        or params_archiveNumber
        or params_subject
        or params_receiverNum
        or params_receiverName
        or params_senderNumber
        or params_senderName
    ):
